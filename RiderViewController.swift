...
class RiderViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate{
    ...
    @IBOutlet var getScoopedButton: UIButton!
    ...
    @IBAction func getScooped(sender: AnyObject) {
        ...
        riderRequest.saveInBackgroundWithBlock {
            ...
            if (success) {
                ...
                self.getScoopedButton.setTitle("Cancel Ride", forState: UIControlState.Normal)
                
                
            } else {
                
                
                var alert = UIAlertController(title: "Could not call Scooper", message: "Please try again", preferredStyle: UIAlertControllerStyle.Alert)
            ...
            self.getScoopedButton.setTitle("Get Scooped", forState: UIControlState.Normal)
                                ...
                                if let objects = objects as? [PFObject] {
                                    ...
                                    for object in objects {
                                        ...
                                        if let driverLocation = object["driverLocation"] as? PFGeoPoint {
                                            ...
                                            self.getScoopedButton.setTitle("Scooper is \(roundedTwoDigitDistance)km away!", forState: UIControlState.Normal)
